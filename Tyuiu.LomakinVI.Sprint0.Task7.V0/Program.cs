...
using Tyuiu.LomakinVI.Sprint0.Task7.V0.Lib;

namespace Tyuiu.LomakinVI.Sprint0.Task7.V0
{
    class Program
    {
        static void Main(string[] args)
        {
            Console.Title = "Спринт #0 | Выполнил: Ломакин В. И. | ИИПб-23-1";
            ...
            if (arrayNums1.Length == arrayNums2.Length)
            {
                ...
                Console.WriteLine("Сумма элементов массивоы равна:");
